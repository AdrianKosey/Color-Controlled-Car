...
void TCS230::begin()
{
    ...
    colors[0] = {342, 1682, 1257, true};   // Rojo
    colors[1] = {2000, 970, 1150, true};   // Verde
    colors[2] = {2410, 2150, 1244, true};  // Azul
    colors[3] = {211, 355, 705, true};    // Amarillo
    colors[4] = {222, 245, 214, true};    // Blanco
    colors[5] = {2390, 2635, 2230, true}; // Negro
}
